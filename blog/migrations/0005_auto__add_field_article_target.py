...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.target'
        db.add_column(u'blog_article', 'target',
                      self.gf('django.db.models.fields.CharField')(default='_self', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.target'
        db.delete_column(u'blog_article', 'target')

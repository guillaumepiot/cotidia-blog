...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'blog_author', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Author.last_name'
        db.alter_column(u'blog_author', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Author.first_name'
        db.alter_column(u'blog_author', 'first_name', self.gf('django.db.models.fields.TextField')(max_length=100))

        # Changing field 'Author.last_name'
        db.alter_column(u'blog_author', 'last_name', self.gf('django.db.models.fields.TextField')(max_length=100))

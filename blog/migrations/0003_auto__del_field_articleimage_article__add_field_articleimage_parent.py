...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'blog_articleimage', 'article_id')

        # Adding field 'ArticleImage.parent'
        db.add_column(u'blog_articleimage', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['blog.Article']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ArticleImage.article'
        db.add_column(u'blog_articleimage', 'article',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['blog.Article']),
                      keep_default=False)

        # Deleting field 'ArticleImage.parent'
        db.delete_column(u'blog_articleimage', 'parent_id')

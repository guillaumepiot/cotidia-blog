...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'blog_category', 'identifier')

        # Deleting field 'Category.published'
        db.delete_column(u'blog_category', 'published')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.redirect_to_url'
        db.add_column(u'blog_article', 'redirect_to_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding M2M table for field related_pages on 'Article'
        db.create_table(u'blog_article_related_pages', (
        ...
        db.create_unique(u'blog_article_related_pages', ['from_article_id', 'to_article_id'])


    def backwards(self, orm):
        # Deleting field 'Article.redirect_to_url'
        db.delete_column(u'blog_article', 'redirect_to_url')

        # Removing M2M table for field related_pages on 'Article'
        db.delete_table('blog_article_related_pages')
    ...
    models = {
        ...
        u'blog.articleimage': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['blog.Article']"})
        },

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Category.order_id'
        db.alter_column(u'blog_category', 'order_id', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Category.order_id'
        db.alter_column(u'blog_category', 'order_id', self.gf('django.db.models.fields.IntegerField')(default=0))

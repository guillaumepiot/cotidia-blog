...
from cotidia.blog.forms.admin.article import ArticleAddForm, ArticleUpdateForm
...
class ArticleDetail(AdminDetailView):
    model = Article
    fieldsets = [
        {"legend": "Content", "template_name": "admin/blog/article/content.html"},
        {
            "legend": "Settings",
            "fields": [
                [
...
def ArticlePublish(request, article_id):
    ...
    template = "admin/blog/article/publish.html"

    return render(
        request,
        template,
        {"object": page, "app_label": "blog", "model_name": "article"},
    )
...
def ArticleUnpublish(request, article_id):
    ...
    template = "admin/blog/article/unpublish.html"
